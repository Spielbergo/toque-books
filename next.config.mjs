...
const securityHeaders = [
  ...
  // Basic CSP: block mixed content; allow Supabase and Google OAuth origins
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://apis.google.com https://helcimcdn.net https://js.helcim.com https://secure.helcim.app",
      ...
      "frame-src blob: 'self' https://accounts.google.com https://*.helcim.com https://helcimcdn.net https://secure.helcim.app",
