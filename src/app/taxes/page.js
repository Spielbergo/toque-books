  ...
  const handlePrevYearFile = e => {
    ...
    reader.onload = ev => {
      try {
        ...
        setPrevYearError('Could not parse file. Please upload a NorthBooks backup JSON.');
      }
    };
    ...
    <div className={styles.page}>
      ...
      <Section title="Import Previous Year Data">
        <div className={styles.prevYearBox}>
          <p className={styles.prevYearNote}>Upload a prior-year NorthBooks backup JSON to pre-fill opening retained earnings, shareholder loan balance, and CCA class UCCs into the current fiscal year. <strong>Nothing is uploaded to any server — all processing happens in your browser.</strong></p>
