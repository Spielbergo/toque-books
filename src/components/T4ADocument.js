...
export default function T4ADocument({ settings, recipients = [], year }) {
  ...
  return (
    <Document
      ...
      author={settings.companyName || 'NorthBooks'}
          ...
          return (
            <View key={idx} style={s.slip} wrap={false}>
              ...
              <View style={s.footerNote}>
                ...
                <Text style={s.footerText}>Generated by NorthBooks — for reference only. File official T4A via CRA My Business Account.</Text>
              </View>
            </View>
          );
        })}
